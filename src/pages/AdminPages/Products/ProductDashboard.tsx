  ...
  return (
    <section>
      <div className='flex justify-between items-center mb-7 md:block'>
        <div>
          <Link to='/admin/admin-sanpham/them' className='bg-sky-600 text-white py-2 px-2 rounded-[5px] cursor-pointer hover:brightness-90 duration-200'>Thêm sản phẩm</Link>  
        </div>
                  ...
                  <tbody>
                    {productList.filter(item => {
                     ...
                     <tr className="border-b" key={item._id}>
                        ...
                        <td onClick={()=>setProdItem(item)} className="py-2 px-6 hover:text-sky-600 hover:underline">
        ...
        <ModalContent className='text-maintext'>
          ...
          <ModalFooter>
            <Button variant='ghost' onClick={deleteProduct}>Xóa</Button>
              <Button variant='ghost' mr={3} ml={2} onClick={onClose}>
              Hủy
            </Button>
          </ModalFooter>
        </ModalContent>
