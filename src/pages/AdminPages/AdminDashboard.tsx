    ...
    <section>
      {/* <div className='grid grid-cols-4 gap-5 text-maintext lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1'>
        <div className='shadow-md'>
          <span className='text-sky-600 text-[25px] bg-rose-100 w-full block py-3 pl-3 border-b-[1px] border-solid border-sky-600'>
            Tổng đơn hàng
          </span>
      ...
      <div>
      <img src ="https://img.lovepik.com/photo/50085/9043.jpg_wh860.jpg" className="w-full h-[700px]"/>
      </div>
    </section>
  )
}
