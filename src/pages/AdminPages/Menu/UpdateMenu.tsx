  ...
  return (
    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <fieldset className='py-4'>
        ...
        <button  type='submit' className='bg-sky-600 h-[40px] w-[120px] text-white rounded-[5px] cursor-pointer hover:brightness-90 duration-200'>Sửa</button>
        {/* bg-sky-600 text-white py-2 px-2 rounded-[5px] cursor-pointer hover:brightness-90 duration-200 */}
    </form>
   </section>
  )
}
