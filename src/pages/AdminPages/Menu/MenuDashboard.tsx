  ...
  return (
    <section>
      <div className='flex justify-between items-center mb-7 md:block'>
        <div>
          <Link to='/admin/admin-thucdon/them' className='bg-sky-600 text-white py-2 px-2 rounded-[5px] cursor-pointer hover:brightness-90 duration-200'>Thêm thực đơn</Link>  
        </div>
      ...
      <Modal finalFocusRef={finalRef} isOpen={isOpen} onClose={onClose}>
        ...
        <ModalContent className='text-maintext'>
          ...
          <ModalFooter>
            <Button  onClick={deleteMenu}>Xóa</Button>
