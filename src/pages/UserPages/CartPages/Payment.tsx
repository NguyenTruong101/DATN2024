...
const Payment = () => {
  ...
  return (
    <section className='max-w-[1200px] m-auto lg:px-5'>
     <h1 className='text-[40px] md:text-[30px] sm:text-[25px] py-5 overflow-hidden relative font-semibold text-sky-600'>Thanh toán</h1>
     <div className='flex justify-end'>
      ...
      <div className='flex md:block'>
        <div className='flex-1 border-r-[1px] border-text2 pr-5'>
          <span className='text-[25px] sm:text-[20px] font-semibold text-sky-600'>
              Sản phẩm
          </span>
           ...
           <span className='text-maintext block mt-4'>Email: <b>{userAcc?.userMail}</b></span>
            ...
            <fieldset className='py-4 text-maintext'>
              ...
              <RadioGroup onChange={handleRadio} mt='12px'>
                <Radio value='tien-mat' colorScheme='blue'>Thanh toán tiền mặt</Radio>
                <Radio value='the' className='ml-5' colorScheme='blue'>Thanh toán bằng thẻ</Radio>
              </RadioGroup>
            </fieldset>
            <button  type='submit' className='bg-sky-600 float-right mt-5 text-white h-[40px] w-[120px] rounded-[5px] cursor-pointer hover:brightness-90 duration-200'>Thanh toán</button>
          </form>
        </div>     
      </div>
    </section>
