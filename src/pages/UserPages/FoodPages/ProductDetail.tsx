    ...
    <section className='mt-8 max-w-[1200px] m-auto lg:px-5'>
        <div className='mb-6 text-maintext flex justify-between'>
          <span className='text-[18px] font-semibold'>
            <Link className='hover:text-sky-600 duration-300' to='/'>Cloud Food</Link> &gt; 
            <Link className='hover:text-sky-600 duration-300' to={`/thuc-don/${product.prodType}`}>{product.prodType}</Link> &gt; 
            {food_name} 
          </span>
        ...
        <div className='flex lg:block'>
          ...
          <div className='text-maintext ml-6 px-5  border-text2 flex-[1_2_0%] flex flex-col'>
            <div>
              ...
              <span className='text-[28px] md:text-[25px] sm:text-[18px] text-sky-600 font-bold py-2 block'>{formatVND(product.prodPrice)}</span>
          </div>
          <div className='mt-3 '>
          ...
          <div className='mt-1'>
              <span className='text-[20px] font-semibold'>Danh mục: <Link to={`/thuc-don/${product.prodType}`} className='hover:text-sky-600 duration-300 text-[16px] font-[400]'>{product.prodType}</Link> </span>
           </div>
          <div className='mt-1'>
           ...
           <div className='mt-10'>
              <button onClick={()=>handleAddToCart(product)} type='button' className='py-2 px-5 bg-sky-600 text-white font-semibold rounded-[10px] hover:brightness-90 duration-200'>
              Thêm vào giỏ hàng
              </button>
          </div>
          </div>
