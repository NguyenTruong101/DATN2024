  ...
  return (
   <section>
    <Container maxW="full" mt={0} centerContent overflow="hidden">
      <Flex>
        <Box className='bg-sky-600' color="white" borderRadius="lg" m={{ sm: 4, md: 16, lg: 10 }} p={{ sm: 5, md: 5, lg: 16 }}>
          <Box p={4}>
                    ...
                    <VStack spacing={5}>
                      <FormControl id="name">
                        ...
                        <InputGroup borderColor="#E0E1E7">                         
                          <Input {...register('nameCt',{required:true,})} onChange={handleAddChange} type="text" size="md"/>
                        </InputGroup>
                      ...
                      <FormControl id="name">
                        ...
                        <InputGroup borderColor="#E0E1E7">
                          <Input {...register('emailCt',{required:true,pattern: emailRegex,})} onChange={handleAddChange} type="text" size="md"/>
                        </InputGroup>
                      ...
                      <FormControl id="name">
                        <FormLabel className='text-maintext'>Lời nhắn</FormLabel>
                        <Textarea
                      ...
                      <FormControl id="name">
                        <Button variant="solid" className='w-full' bg="#00aaee" color="white" type='submit' _hover={{}}>Gửi đi</Button>
                      </FormControl>
                    </VStack>
                  </Box>
                </Box>
