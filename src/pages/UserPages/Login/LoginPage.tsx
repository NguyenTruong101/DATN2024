  ...
  return (
    <Flex minH={'100vh'} justify={'center'} bg={useColorModeValue('gray.50', 'gray.800')}>
      ...
      <Stack spacing={8} mt={10} mx={'auto'} maxW={'lg'} py={12} px={6}>
        <Stack align={'center'}>
          <Heading fontSize={'4xl'} className='text-sky-600'>Đăng nhập Cake</Heading>
        </Stack>
          ...
          <Stack spacing={4}>
            <form onSubmit={handleSubmit(onSubmit)} className='text-maintext'>
              <FormControl id="email">
                ...
                <Input {...register('userMail',{required:true,pattern: emailRegex,})} onChange={handleInputData} type="text" focusBorderColor='#00aaee' />
              ...
              <FormControl id="password" mt={5}>
                ...
                <Input {...register('userPassword',{required:true,minLength:6})} onChange={handleInputData} type="password" focusBorderColor='#00aaee' />
              ...
              <Stack spacing={4}>
                <Stack
                  ...
                  <Link to='/dang-ky' className='text-red-600 mt-8'>Chưa có tài khoản? Đăng ký ngay</Link>
                </Stack>
                <Button type='submit' bg={'#00aaee'} color={'white'} _hover={{bg: '',}}>Đăng nhập</Button>
              </Stack>
            </form>
          </Stack>
        </Box>
