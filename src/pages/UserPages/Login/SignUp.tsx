  ...
  return (
    <Flex align={'center'} justify={'center'} minH={'100vh'} bg={useColorModeValue('gray.50', 'gray.800')}>
      <Stack spacing={8} mx={'auto'} mb={20} py={5} px={6}>
        <Stack align={'center'}>
          <Heading fontSize={'4xl'} className='text-sky-600'>Đăng ký tài khoản Cake</Heading>
        </Stack>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className='text-maintext'>
              ...
              <Stack spacing={4}>
                <Stack
                  ...
                  <Link to='/dang-nhap' className='text-red-600 mt-8'>Đã có tài khoản? Đăng nhập ngay</Link>
                </Stack>
                <Button type='submit' bg={'#00aaee'} color={'white'} _hover={{bg: '',}}>Đăng ký</Button>
              </Stack>
            </form>
          </Stack>
        </Box>
