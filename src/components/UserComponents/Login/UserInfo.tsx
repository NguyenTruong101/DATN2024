...
const UserInfo = () => {
  ...
  return (
    <section className='max-w-[1200px] m-auto lg:px-5'>
      ...
      <div>
        <h2 className='text-[30px] sm:text-[25px] py-5 overflow-hidden relative font-semibold text-sky-600'>Thông tin cá nhân</h2>
        <div className='flex'>
          <div>
            <img 
              title= {userAcc?.userName}
              className='h-[100px] w-[100px] rounded-full border-[3px] border-solid border-sky-600' 
              src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSuCf31SSHaH1Z8oPndTOFf1FctAz3_1GSQCe_7AA4wsDvpxNp2xh3pck7M5HGHj97zG8g&usqp=CAU' 
      ...
      <hr/>
      <div>
        <h2 className='text-[30px] sm:text-[25px] py-5 overflow-hidden relative font-semibold text-sky-600'>Danh sách đơn hàng</h2>
        <div>
          {orderList.length === 0 ?
