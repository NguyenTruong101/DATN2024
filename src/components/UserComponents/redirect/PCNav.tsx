      ...
      <div className='max-w-[1200px] py-3 m-auto flex items-center'>
        <NavLink to='/'>
          <div className='flex items-center cursor-pointer mb-1'>
            <img alt="icon" className='h-[40px] w-[40px]' src={require('../../../assets/imgs/cake.png')}/>
            <span className='font-bold text-[25px] ml-2 text-sky-600'>Cake</span> 
          </div>
        </NavLink>
        <div className="flex justify-between flex-1 ml-7 items-center">
          <div>
            <ul className="flex">
              <li className='cursor-pointer px-3 capitalize font-bold hover:text-sky-600 text-maintext lg:text-[14px] duration-300'>
